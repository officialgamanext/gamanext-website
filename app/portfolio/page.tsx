...
export default function PortfolioPage() {
  return (
    <div className="py-20 px-4 max-w-7xl mx-auto text-center space-y-6">
      <div className="inline-flex items-center justify-center p-4 bg-emerald-50 text-emerald-600 rounded-2xl">
      ...
      <p className="max-w-2xl mx-auto text-lg text-slate-600">
        Explore our recent web development, e-commerce, custom software, and branding projects.
      </p>
      <div className="pt-4">
        <div className="inline-block p-6 bg-white border border-slate-200 rounded-2xl shadow-sm max-w-md">
          <p className="text-slate-500 text-sm font-medium">
            Page under active construction. Full project case studies will be published here soon.
          </p>
        </div>
      </div>
      <div className="pt-6">
